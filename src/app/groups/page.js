...
export default function Groups() {
  ...
  const suggestions = [
    { name: "Bruins Art Club", joinStatus: false, location: "Covel Commons", time: "7:00 pm - 9:00 pm", members: ["Member 1", "Member 2"] },
    { name: "Physics 1B Study Group", joinStatus: false, location: "Physics and Astronomy Building", time: "4:00 pm - 6:00 pm", members: ["Member 1", "Member 2"] },
    { name: "Polisci Research Group", joinStatus: false, location: "Public Affairs Building", time: "9:00 am - 12:00 pm", members: ["Member 1", "Member 2"] },
  ];
