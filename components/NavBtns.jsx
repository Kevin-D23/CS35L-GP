...
export default function NavBtns(){
    ...
    return (<div className={styles.navBtnContainer}>{pages.map((page, key) => {
        return (
          <Link className={styles.navBtn} key={key} href={page.page} style={page.page == path ? {background:"#E7E7EB"} : {}}>
            {page.icon}
            {page.name}
          </Link>
        );
